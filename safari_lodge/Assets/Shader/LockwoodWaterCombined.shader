	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" "SPECULAR_ON" }
					"!!GLES
					#version 100
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_LINEAR" "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" "SPECULAR_ON" }
					"!!GLES
					#version 100
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP" "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" "SPECULAR_ON" }
					"!!GLES
					#version 100
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP2" "LKWD_LIGHTMAP_ON" "VERTEX_COLOUR" "SPECULAR_ON" }
					"!!GLES
					#version 100
