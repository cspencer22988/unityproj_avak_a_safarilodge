			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  pos_1.xyz = (_glesVertex.xyz + ((
					    (_glesNormal * ((_WindEdgeFlutter * tmpvar_7.x) * _glesColor.x))
					   + 
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD0 = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
					  xlv_TEXCOORD1 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD2 = ((tmpvar_8.z * unity_FogParams.z) + unity_FogParams.w);
					}
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD0 = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
					  xlv_TEXCOORD1 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD2 = exp2(-((unity_FogParams.y * tmpvar_8.z)));
					}
